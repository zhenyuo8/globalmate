...
.mineInformation_hobby,
.mineInformation_school,
.mineInformation_comment {
  font-size: 14px;
  color: #999;
  width: 80%;
  padding: 16px 0.2rem;
...
.mineInformation_hobby_title,
.mineInformation_comment_title {
  height: 32px;
  line-height: 32px;
  position: absolute;
  top: -16px;
...
.mineInformation_hobby_offer span,
.mineInformation_hobby_love span {
  line-height: 32px;
  color: #333;
  font-size: 13px;
  margin-left: 0.12rem;
